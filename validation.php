 ...
 * @homepage https://github.com/witty/validation
 * @version 0.1.0
 */
class Validation extends Witty_Base {
	...
	public function check()
	{
		...
		foreach ($rules as $field => $set)
		{
			...
			{
				if ( ! in_array($rule, $this->_empty_rules) && ! Validation::not_empty($value))
				{
					continue;
				}
